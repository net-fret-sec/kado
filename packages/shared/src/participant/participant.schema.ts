...
export type CreateParticipantInput = z.infer<
  typeof createParticipantInputSchema
>;
export type ParticipantIdParam = z.infer<typeof participantIdParamSchema>;
export type ExchangeAndParticipantIdParam = z.infer<
  typeof exchangeAndParticipantIdParamSchema
>;
export type UpdateParticipantInput = z.infer<
  typeof updateParticipantInputSchema
>;
export type RegenerateParticipantAccessInput = z.infer<
